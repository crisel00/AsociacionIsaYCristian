...
import com.cromero.asociacionisaycristian.managerViews.view_addStore;
...
public class User_StoreManagement extends Fragment {

    ArrayList<Store> stores;
    DatabaseReference dbRefenrece = FirebaseDatabase.getInstance().getReference();
    RecyclerView recView;

    public User_StoreManagement() {
        User_StoreManagement fragment = new User_StoreManagement();
        Bundle args = new Bundle();
    }


    public static User_StoreManagement newInstance() {
        User_StoreManagement fragment = new User_StoreManagement();
        Bundle args = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_user__store_management, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recView = (RecyclerView) view.findViewById(R.id.rv_userStore);
